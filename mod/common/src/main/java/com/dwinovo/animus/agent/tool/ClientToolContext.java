 ...
 * agent — the {@code AnimusEntity} body the loop drives, plus its vanilla
 * entity id. Perception tools call {@link #anchor()} to get the perspective
 * centre.
 *
 ...
 */
public record ClientToolContext(AnimusEntity entity, int vanillaEntityId) {
