...
public final class UseItemTool implements AnimusTool {
    ...
    public String description() {
        return "Right-click an item like a player would, optionally on a target "
                ...
                + "within reach first) — e.g. flint_and_steel on the obsidian of a "
                + "nether portal to light it, an ender_eye on an end_portal_frame to "
                + "fill it, bonemeal on a crop. Omit x/y/z to use it in the air — "
