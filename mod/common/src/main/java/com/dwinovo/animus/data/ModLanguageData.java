...
public final class ModLanguageData {
    ...
    public static final class Keys {
        ...
        public static final String GUI_PROMPT_SETTINGS = "animus.gui.prompt.settings";
    ...
    private static void addEn(Adder adder) {
        ...
        adder.add(Keys.GUI_PROMPT_SETTINGS, "Settings");
    ...
    private static void addZh(Adder adder) {
        ...
        adder.add(Keys.GUI_PROMPT_SETTINGS, "设置");
