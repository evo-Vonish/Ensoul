 ...
 * {@link com.dwinovo.animus.pathing.exec.PlayerNav} submits its search here and polls the returned
 * future each tick.
 *
...
public final class PathPlannerPool {
    ...
    private static final ThreadPoolExecutor POOL = new ThreadPoolExecutor(
            ...
            runnable -> {
                Thread thread = new Thread(runnable, "animus-path-" + COUNTER.incrementAndGet());
